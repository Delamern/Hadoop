...
public class PairOfInts implements WritableComparable<PairOfInts> {
	 ...
	 *            the right element
	 */
	public PairOfInts(int left, int right, double nTF) {
		set(left, right, nTF);
	}
	...
	/**
	 * Returns the normTF element.
	 * 
	 * @return the normTF element
	 */
	public double getnormTF() {
		return normTF;
	}
	 ...
	 *            the right element
	 */
	public void set(int left, int right, double norm) {
		leftElement = left;
		rightElement = right;
		normTF = norm;
	}
	...
	public String toString() {
		return "(" + leftElement + ", " + rightElement + ", " +  ", " + normTF + ")";
	}
	...
	public PairOfInts clone() {
		return new PairOfInts(this.leftElement, this.rightElement, this.normTF);
	}
